...
import { authApi, type SignupCitizenRequest } from "@/lib/api";
import { validateCitizenSignupForm } from "@/lib/validation";
import { Shield, Loader2, CheckCircle } from "lucide-react";

const SignupCitizen = () => {
  const [formData, setFormData] = useState<SignupCitizenRequest>({
    full_name: "",
    email: "",
    mobile: "",
    aadhaar_id: "",
  ...
  const handleInputChange = (field: keyof SignupCitizenRequest, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validation = validateCitizenSignupForm(formData);
    ...
    try {
      const response = await authApi.signupCitizen(formData);
    ...
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-muted-foreground">
          Create your account to access government subsidies
        </p>
      </div>
        ...
        <div className="auth-card py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <FormField
              ...
              onChange={(value) => handleInputChange("aadhaar_id", value)}
          ...
          <div className="mt-8 pt-6 border-t border-border">
            <div className="gdpr-notice text-center">
              ...
              government security standards and GDPR compliance. Your Aadhaar information 
